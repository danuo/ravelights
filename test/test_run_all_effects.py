...
def test_all_effects_2_inf(app_time_patched_2):
    run_all_effects_inf(app_time_patched_2)


def test_all_effects_2_limited(app_time_patched_2):
    run_all_effects_limited(app_time_patched_2)


def run_all_effects_inf(app: RaveLightsApp):
...
def run_all_effects_limited(app: RaveLightsApp):
    app.settings.enable_autopilot = False
