...
class TimeHandler:
    ...
    def measure_time_2(self) -> None:
        """Measure time after render cycle and sleep"""
        self.time_2 = self.get_current_time()

    def bpm_sync(self) -> None:
        """Synchronize bpm"""
        self.time_sync = self.get_current_time()

    def sleep_static(self, t: float = 1 / 30) -> None:
        time.sleep(t)

    def sleep_dynamic(self) -> None:
    ...
    def _calculate_fps_stats(self) -> None:
    ...
    def _calculate_avg_render_time(self) -> None:
        """Calculates average of time1-time0 (render time) for last 10 framess"""
        if len(self.render_time_deque) < 5:
    ...
    def _calibrate_sleep_dynamic(self) -> None:
