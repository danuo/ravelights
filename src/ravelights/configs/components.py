...
blueprint_generators: list[BlueprintGen] = [
    ...
    BlueprintGen(VfilterTimeDelay, dict(name="v_time_delay_left", version=1)),
    BlueprintGen(VfilterTimeDelay, dict(name="v_time_delay_right", version=2)),
    ...
    BlueprintGen(VfilterMapPropagate, dict(name="v_map_propagate")),
